            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                           <div class="text-center">
                               <a href="{{ url('adm/noticia/create') }}" class="btn btn-app text-center">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                @foreach($cpro as $pro)
                                   <tr id="tabla_{{$pro->id}}">
                                    ...
                                    <td>{{ $pro->visitas }}</td>
                                    <td>{{ $pro->index==0 ?'No' : 'Si'}}</td>
                                    <td>{{ $pro->orden }}</td>
                                    <td>
                                        <div class="botns">
                                            <a href="{{ url('adm/noticia/'.$pro->id.'/edit') }}" class="btn btn-raised btn-primary btn-xs">Editar<i class="fa fa-edit"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            {!! Form::open(['url'=>'adm/noticia/'.$pro->id,'method'=>'DELETE']) !!}
    ...
    <script src="{{asset('admin/vendors/datatables.net-scroller/js/datatables.scroller.min.js')}}"> </script>
      ...
      $( ".sopor" ).sortable({
        ...
        $('.esta').click(function(e){
            ...
            $.get('{{url('adm/cambiar_blog/')}}/' + elid, function (res, estado) {
                if(res==1){
