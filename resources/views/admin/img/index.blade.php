            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                           <div class="text-center">
                               <a href="{{ url('adm/img/create') }}" class="btn btn-app text-center">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                @foreach($cpro as $pro)
                                   <tr id="tabla_{{$pro->id}}">
                                    ...
                                    <td>  @if(isset($pro->image[0]->images))<img src="{{asset('img/'.$pro->image[0]->images)}}" width="100" alt="{{$pro->image[0]->nimages}}"/>
                                              @else No hay imágenes.
                                        @endif
                                    </td>

                                   <td>{{count($pro->image)}}</td>
                                   <td>{{$pro->orden}}</td>

                                    <td>
                                        <div class="botns">
                                            <a href="{{ url('adm/img/'.$pro->id.'/edit') }}" class="btn btn-raised btn-primary btn-xs">Editar<i class="fa fa-edit"></i>
