    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                {!! Form::model($cpro,['url'=>['adm/comentario',$cpro->id], 'method'=>'patch', 'files' => true , 'class'=>'form-horizontal formulario']) !!}
                @include('admin.comentario.form')
                {!! Form::close() !!}
            </div>
        </div>
    </div>
...
@section('script')
    ...
    <script src="{{asset('admin/js/jquery.rateyo.min.js')}}"></script>

    <script>
        $('.starnew').rateYo({
            starWidth: "30px",
            ratedFill: "#E74C3C",
            rating    : '{{$cpro->puntuacion}}',
            fullStar: true,
            multiColor: {
                "startColor": "#e1d800",
                "endColor"  : "#e1d800"
