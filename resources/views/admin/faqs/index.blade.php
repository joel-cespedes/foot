            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                           <div class="text-center">
                               <a href="{{ url('adm/faq/create') }}" class="btn btn-app text-center">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered">
                                ...
                                @foreach($cpro as $pro)
                                   <tr id="tabla_{{$pro->id}}">
                                    ...
                                    <td>
                                        <div class="botns">
                                            <a href="{{ url('adm/faq/'.$pro->id.'/edit') }}" class="btn btn-raised btn-primary btn-xs">Editar<i class="fa fa-edit"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            {!! Form::open(['url'=>'adm/faq/'.$pro->id,'method'=>'DELETE']) !!}
