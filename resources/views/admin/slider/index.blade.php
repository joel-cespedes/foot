            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                           <div class="text-center">
                               <a href="{{ url('adm/sliders/create') }}" class="btn btn-app text-center">
                        ...
                        <div class="row">
                            <table id="datatable-buttons" class="table sopor table-striped table-bordered">
                                <thead>
                                <tr>
                                    <th>Id</th>
                                    <th>img</th>
                                ...
                                <tr id="tabla_{{$pro->id}}">
                                    <td>{{$pro->id}}</td>
                                    <td><img src="{{asset('img/'.$pro->img.'')}}"  width="80" alt=""></td>
                                    <td>{{$pro->orden}}</td>
                                    <td>
                                        <div class="botns">
                                            <a href="{{ url('adm/sliders/'.$pro->id.'/edit') }}" class="btn btn-raised btn-primary btn-xs">Editar<i class="fa fa-edit"></i>
                                                <div class="ripple-container"></div>
                                            </a>
                                            {!! Form::open(['url'=>'adm/sliders/'.$pro->id,'method'=>'DELETE']) !!}
                                            {{ csrf_field() }}
...
//
        ...
        $('.slii').click(function(e){

            var elid = $(this).data('v');

            $.get('{{url('adm/cambiar_slider/')}}/' + elid, function (res, estado) {
