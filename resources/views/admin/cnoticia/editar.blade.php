...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                <h2>Editar Categoria de Noticia</h2>
            ...
            <div class="x_content">
                ...
                {!! Form::model($cpro,['url'=>['adm/cnoticia',$cpro->id], 'method'=>'patch', 'files' => true , 'class'=>'form-horizontal formulario']) !!}

                @include('admin.cnoticia.form')
